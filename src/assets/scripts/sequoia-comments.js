...
.sequoia-reply-bluesky {
	background: var(--sequoia-bluesky-button-bg, var(--sequoia-button-bg, var(--sequoia-accent-color, #2563eb)));
	color: var(--sequoia-bluesky-button-text-color, var(--sequoia-button-text-color, #ffffff));
	border: var(--sequoia-bluesky-button-border, var(--sequoia-button-border, none));
}

.sequoia-reply-blacksky {
	background: var(--sequoia-blacksky-button-bg, var(--sequoia-button-bg, var(--sequoia-accent-color, #6060E9)));
	color: var(--sequoia-blacksky-button-text-color, var(--sequoia-button-text-color, #ffffff));
	border: var(--sequoia-blacksky-button-border, var(--sequoia-button-border, none));
}

.sequoia-reply-bluesky:hover {
	background: var(--sequoia-bluesky-button-hover-bg, var(--sequoia-button-hover-bg, color-mix(in srgb, var(--sequoia-accent-color, #2563eb) 85%, black)));
	color: var(--sequoia-bluesky-button-hover-text, var(--sequoia-button-hover-text, #ffffff));
}

.sequoia-reply-blacksky:hover {
	background: var(--sequoia-blacksky-button-hover-bg, var(--sequoia-button-hover-bg, color-mix(in srgb, var(--sequoia-accent-color, #5252c3) 85%, black)));
	color: var(--sequoia-blacksky-button-hover-text, var(--sequoia-button-hover-text, #ffffff));
}
