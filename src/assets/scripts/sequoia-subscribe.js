...
.sequoia-button {
	...
	gap: 0.375rem;
	padding: 0.5rem 1rem;
	background: var(--sequoia-button-bg, var(--sequoia-accent-color, #2563eb));
	color: var(--sequoia-button-text-color, #ffffff);
	border: var(--sequoia-button-border, none);
...
.sequoia-button:hover:not(:disabled) {
	background: var(--sequoia-button-hover-bg, color-mix(in srgb, var(--sequoia-accent-color, #2563eb) 85%, black));
	color: var(--sequoia-button-hover-text, #ffffff);
}
