...
date: 2025-01-30T12:39:14+00:00
id: bbaf6d5b-3460-4b40-be6f-d76d3ce107cb
tags:
  - social-media
  - mastodon
  - fediverse
...
ogImage: follower-count-preview.jpeg
---
...
- [On Mastodon](https://social.lol/@chrisplusplus), I kept to my usual "follow only select accounts you know and enjoy, adding new follows rarely" approach.
- Meanwhile, over [on Bluesky](https://bsky.app/profile/chrismcleod.dev), I threw some of that caution to the wind and followed with wild abandon[^1], using Starter Packs for subjects I enjoy to give me a head-start. I was still reviewing these starter packs and their creator, so I wasn't following accounts completely blind, but I wasn't being cautious with the number of accounts I followed.
...
I think I've come to the conclusion that on these no/less alorithm-driven platforms **I prefer following more accounts**, though I could probably trim the Bluesky number down _a bit_. The higher follower count just makes for a much more varied and lively feed, which feels more enjoyable. After a bit of adjustment, don't feel the need anymore to read every update I might have missed. I just dip in and absorb what's there in the moment, then dip out. Custom feeds such as "[Quiet Posters](https://bsky.app/profile/did:plc:vpkhqolt662uhesyj6nxm7ys/feed/infreq)" help too. On Mastodon I see most updates from those I follow, as the numbers are relatively low, but it's easy for the feed to be dominated by 1 particular account or topic at a time, and this doesn't feel great - particularly at the moment.

So, I guess I need to start ramping up my following activity on the fediverse. There currently aren't fully integrated starter packs to make that easier - though there are [proposals](https://github.com/mastodon/mastodon/issues/32946) and [3rd-party tools](https://fedidevs.com/starter-packs/) out there to change that - so for now I'll have to do that the old fashioned way: discovery and recommendations. _Hint, hint_.

[^1]: I still don't do the automatic follow back thing though. [That's how you get disinfo campaigns](https://bsky.app/profile/rahaeli.bsky.social/post/3layll67et22y). 
